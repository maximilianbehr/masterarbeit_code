    ...
    for j in range(len(problems)):
        ...
        for i in range(len(solvers)):
            if to_screen:
                ...
                print "python ns.py " + problems[j], solvers[i], "refinement_level=" + str(refinements[k]), ">&", \
                    problems[j] + "_" + solvers[i] + "_" + str(refinements[k])
                jobs.append(("python ns.py " + problems[j] + " " + solvers[i] + " " + "refinement_level=" + str(
                    refinements[k]) + " " + "debug=True" + ">&" + " " + problems[j] + solvers[i] + "_" + str(
                    refinements[k])))
                os.system("python ns.py " + problems[j] + " " + solvers[i] + " " + "refinement_level=" + str(
                    refinements[k]) + " " + "debug=True")
